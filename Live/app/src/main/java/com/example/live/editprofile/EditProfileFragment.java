        ...
        dialog.setOnOKListener(new EditStrProfileDialog.OnOKListener() {
            ...
            public void onOk(String title, final String content) {
                try {
                    ...
                    TIMFriendshipManager.getInstance().setCustomInfo("Tag_Profile_Custom_renzheng", content.getBytes("utf-8"), new TIMCallBack() {
                        @Override
                        public void onError(int i, String s) {
                            Log.i("EditProfileFragment",i+" ");
                        ...
                        public void onSuccess() {
                            ...
                            Toast.makeText(getActivity(), "更新认证成功", Toast.LENGTH_SHORT).show();
                            getSelfInfo();
                        }
                    });
